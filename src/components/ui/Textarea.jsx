...
export const Textarea = forwardRef(({
    ...
    const inputBase = "w-full min-h-[56px] bg-white border-2 rounded-xl py-3.5 px-4 text-[length:var(--font-base)] text-neutral-900 placeholder:text-neutral-400 placeholder:not-italic focus:outline-none focus:ring-0 disabled:bg-neutral-100 disabled:text-neutral-400 disabled:cursor-not-allowed resize-y";
